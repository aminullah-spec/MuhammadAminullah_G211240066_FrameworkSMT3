...
<style>
    ...
    thead tr th {
        background: #23395d !important;    /* Naval blue - lebih terang */
    ...
    tbody tr td {
        background: #3b4c5c !important;    /* Blue grey - lebih cerah */
    ...
    tbody tr:hover td {
        background: #4f6275 !important;    /* Hover lebih terang */
        transition: 0.2s;
    }
    ...
    <div class="main-card">
        ...
        <div class="d-flex justify-content-between mb-4">
            ...
            <form action="" method="GET" class="d-flex align-items-center">
                <input type="text" name="search" class="search-input form-control me-2" placeholder="Cari nama / buku">
            ...
            <table class="table table-bordered align-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('pinjam/edit/'.$row->ID_Pinjam) }}" class="btn btn-primary btn-sm">Edit</a>
